...
foreach ($publisherItem as $publisher)
    if (isset($_POST['bthSub'])) {
        ...
        $publisherModel = new PublisherModel();
        $publisherModel->editPublisher($id,$name,$status,$ornum,$update);
    }
?>
    ...
    <div class="content">
        <form action="" method="POST" target="_self">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="id" name="id" placeholder="Mã NXB..." class="form-control input-md" required="" type="text" value="<?Php echo '' . $publisher['id'] . ''; ?>" disabled>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="ordinal_number" name="ordinal_number" placeholder="Số thứ tự..." class="form-control input-md" required="" type="text" value="<?Php echo '' . $publisher['ordinal_number'] . ''; ?>">
                </div>
            </div>
