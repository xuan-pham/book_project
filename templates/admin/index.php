                                    ...
                                    <div id="cardCollpase4" class="collapse show">
                                        <div class="card-body">
                                            <div class="todoapp">
                                                ...
                                                <ul class="list-group slimscroll todo-list" style="max-height: 310px;" id="todo-list"></ul>
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group list-group-lg">
                                                <li class="list-group-item border-0 pt-2">
                                                    <a href="" class=" mr-3">
                                                        <img src="assets\images\users\avatar-3.jpg" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="assets\images\users\avatar-4.jpg" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="assets\images\users\avatar-5.jpg" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="assets\images\users\avatar-6.jpg" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="assets\images\users\avatar-7.jpg" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="assets\images\users\avatar-8.jpg" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                    <span class="float-right badge badge-info mt-2">Webdesigner</span>
                                                ...
                                                <li class="list-group-item border-0 pb-1">
                                                    <a href="" class=" mr-3">
                                                        <img src="assets\images\users\avatar-9.jpg" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                    <span class="float-right badge badge-warning mt-2">Webdeveloper</span>
                                                    <a href="">John Deo</a>
                                                </li>
